...
This is the entry point for all Claude Code memory in this project.

Read all three indexes below at the start of every task. Open individual files only when the task scope matches their description — never speculatively.
