...
Rules are constraints and conventions Claude must follow. They define what to do, what never to do, and how to behave in specific situations.

Read a rule file when the current task matches its scope description.
